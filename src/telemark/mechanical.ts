...
const MODULE_SEEDS: ModuleSeed[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      {slug: 'assemblies-and-mates', label: 'Assemblies', title: 'Lesson 5.3: Assemblies, Mates, and Checking Range of Motion'},
      {slug: 'part-libraries', label: 'Part Libraries', title: 'Lesson 5.4: Using Vendor Part Libraries and Managing Versions'},
    ],
  },
  {
    number: '06',
