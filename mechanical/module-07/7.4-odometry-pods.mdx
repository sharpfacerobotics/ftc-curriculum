...
This is the lesson where mechanical work most directly determines whether the software team's autonomous routines are repeatable. When a programmer says the robot's position drifts, the cause is usually in this lesson.
