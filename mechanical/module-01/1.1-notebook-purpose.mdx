...
Most teams treat the notebook as a chore assigned to whoever is least interested in building. That produces a document written in the last two weeks of the season, describing a robot the writer did not design, in language that reveals nobody was taking notes at the time.

Judges recognize this immediately, because the notebook they want to see cannot be written retroactively.

---

## Two Audiences, Both Real

**Your team, three weeks from now.** Why is the intake spool 1.4 inches instead of 2? Someone knew in October. By January that person has forgotten, and if the spool ever needs replacing, the team either rediscovers the reasoning through testing or guesses. A notebook that captures decisions is a defense against your own forgetting.
...
That last row surprises teams. A notebook full of successes reads as fiction. A notebook that says "the slide bound at full extension three times out of ten, we traced it to the third stage flexing, and here is what we changed" reads as engineering.

:::tip Failures are the most valuable entries
The entry describing something that did not work, what you measured, and what you concluded is worth more than three entries describing something that worked. It is also the entry a judge is most likely to ask about, because it is the one that proves the process is real.
:::
...
If you go digital, timestamp entries as you write them and resist editing old pages. The value of the notebook comes from it being a record, and a record you rewrite is a story.
