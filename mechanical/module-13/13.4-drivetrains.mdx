...
Drivetrain arguments in FTC are usually about the wheel type. Mecanum or omni or traction, six wheel or four. That is the least interesting part of the decision.

The drivetrain's real job is to put force into the floor and to know where it is. Those two jobs, traction and localisation, explain nearly every choice teams make, including the ones that look like fashion.
