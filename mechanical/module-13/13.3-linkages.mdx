...
The obvious fix is a second motor to rotate the claw back as the arm rises. It works, it costs a motor, a controller port, and a control problem, and it is almost never necessary. Geometry solves this for free.
...
This is why four-bars appear in FTC every single season. It is not tradition. It is that a parallelogram is a mechanical guarantee of orientation, and guarantees are rare.
