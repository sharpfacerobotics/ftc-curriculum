...
title: "Lesson 5.3: Assemblies, Mates, and Checking Range of Motion"
sidebar_label: "5.3 · Assemblies"
sidebar_position: 3
---

import MarkComplete from '@site/src/components/HomepageFeatures/MarkComplete';

# Lesson 5.3: Assemblies, Mates, and Checking Range of Motion

---

## Technical Context

An assembly is where parts stop being individually correct and start being collectively wrong. The value of assembling in CAD is that the mechanism moves, so you can drive it through its full range and watch for the position where it hits something.
...
<MarkComplete
  ...
  nextUnitName="Lesson 5.4: Using Vendor Part Libraries and Managing Versions"
/>
