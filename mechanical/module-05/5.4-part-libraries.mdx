---
id: part-libraries
title: "Lesson 5.4: Using Vendor Part Libraries and Managing Versions"
sidebar_label: "5.4 · Part Libraries"
sidebar_position: 4
---

import MarkComplete from '@site/src/components/HomepageFeatures/MarkComplete';

# Lesson 5.4: Using Vendor Part Libraries and Managing Versions

---

## Technical Context

Modeling a motor from a datasheet takes forty minutes and produces a part that is probably slightly wrong. The vendor already published it. Using published models is not laziness; it is the difference between a team that finishes a CAD model and one that does not.
