...
Every dimension you have typed so far was a number sitting alone in a feature. Nothing in the model records *why* it is that number, or which other dimensions have to change with it.

Variables fix that. They are the difference between a model you edit and a model you drive.
