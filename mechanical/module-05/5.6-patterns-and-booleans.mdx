...
These features do not create new shapes. They repeat, combine, and reposition geometry that already exists. They are where a model stops being a pile of features and starts being maintainable, because each of them replaces work you would otherwise repeat by hand.
