...
A motor spec sheet gives two headline numbers: free speed and stall torque. Teams read the free speed, assume the mechanism runs at that speed, and design a cycle time around it.

The motor never runs at free speed while doing work. Understanding where it actually runs is the difference between a predicted cycle time and a real one.
