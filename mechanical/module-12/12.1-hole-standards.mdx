...
Everything else in this track asks you to decide something. This module is the part that is already decided.

A team that re-derives hole sizes every time gets them wrong eventually, usually at 11pm in week seven. These numbers go on the wall.
