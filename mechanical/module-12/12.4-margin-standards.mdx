...
A robot that works once has no margin. A robot that works in match five, on the fourth battery, with a heavier game element than you tested with, has margin.

These are the numbers that separate the two.
...
3. Reserve about `__________` percent of the weight budget for what nobody predicted.
