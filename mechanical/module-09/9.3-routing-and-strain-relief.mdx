...
A robot that sits still does not break wires. A robot that extends a slide sixty times a match, gets hit, and vibrates continuously breaks wires at a predictable rate, always at the same places.

Routing is the discipline of deciding where wires go before they are installed, rather than running them wherever there is room and discovering the consequences at a tournament.
