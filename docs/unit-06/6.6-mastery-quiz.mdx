...
**2. Parallel Execution:** In a responsive TeleOp, why is using the `sleep()` method considered poor engineering practice compared to `getRuntime()` comparisons?
...
<ScoredQuiz
  ...
  questions={SOFTWARE_QUESTIONS['unit-06']}
/>
