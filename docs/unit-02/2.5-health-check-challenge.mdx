...
# Lesson 2.5: Challenge — Implementing a Robot Health-Check OpMode with Telemetry Feedback
...
**Robot Scenario:** Create a master health-check program. Use `init_loop()` to show the driver the current runtime while they are waiting to press start, and use `stop()` to print "Robot Powering Down".
