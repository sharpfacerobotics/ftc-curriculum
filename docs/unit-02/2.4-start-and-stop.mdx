...
# Lesson 2.4: Utilizing start() and stop() for One-time Hardware Transitions
...
**Robot Scenario:** Your team needs to reset the robot's timer at the start of the match and display a "Robot Shutdown" message when the program is stopped.
