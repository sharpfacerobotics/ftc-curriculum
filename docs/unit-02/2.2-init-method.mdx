...
# Lesson 2.2: Initializing Peripheral Hardware within the init() Method
...
**Robot Scenario:** You need to prepare a `Servo` named `"claw"` for the match. Use the `init()` method to map it and ensure it is ready to move once the match starts.
