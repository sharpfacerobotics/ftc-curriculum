...
# Lesson 8.4: Utilizing setPower(0.0) for Consistent Coast vs. Stop Behavior
...
<MarkComplete
  ...
  nextUnitName="Lesson 8.5: Challenge — Creating a Bidirectional Linear Slide Control with Software Limiters"
/>
